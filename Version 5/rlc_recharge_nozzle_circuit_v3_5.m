function [eta_KE,eta_circ,eta_sys]=rlc_recharge_nozzle_circuit_v3_5(circInps,plasmaInps,graphDisplay)

% Nathan Schilling
% 04/14/2020
% Need to re-do this to output everthing that comes out of the ode45
% solver...
