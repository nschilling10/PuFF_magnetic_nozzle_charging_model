function energies=calCompEnergies(modelOutputs, circInps, plasmaInps)
...
for i=1:length(energies.E_R1)
    if i == 1
        ...
        energies.E_R1(i)=circInps.R1*trapz(t(1:i),modelOutputs.I1(1:i).^2)*MJ;
    end
end
...
for i=1:length(E_R2)
    if i == 1
        ...
        energies.E_R2(i)=circInps.R2*trapz(t(1:i),modelOutputs.I2(1:i).^2)*MJ;
    end
end
...
T_0=T0+0.5*(gamma-1)*(modelOutputs.V_plasma(1).^2/(gamma*Rgas));
